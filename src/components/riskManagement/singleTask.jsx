...
import {Form,Input,Button,Select, Row, Col, Tooltip, InputNumber } from 'antd';
import {Interface} from 'Lib/config/index';
const { contentType, } = Interface;

const {TextArea} = Input;
class SingleTask extends CLComponent {
  constructor(props) {
    super(props);
    this.bindCtx([
      'handleSubmit',
...
const CLForm = Form.create({ name: 'normal_login' })(SingleTask)
