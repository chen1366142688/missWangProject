...
let {contentType, appMonitorProductVersionPacket, telephoneManagerQueryMemberInfo, memberSmsSendCheckAddMemberSMSSendCheck} = Interface;
  ...
  getFields = (fields) => {
    ...
    if(reg.test(fields.telephoneNo) === false){
      ...
      let params = {
        ...
        telephoneNo: fields.telephoneNo,
      ...
      confirm({
        ...
        onOk() {
          ...
          const settings = {
            contentType,
            method: memberSmsSendCheckAddMemberSMSSendCheck.type,
            url: memberSmsSendCheckAddMemberSMSSendCheck.url,
