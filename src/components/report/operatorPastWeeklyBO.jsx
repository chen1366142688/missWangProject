...
let { contentType, getWeekOverDueReport } = Interface;
let TB;

//运营周报 逾期方向历史周

class OperatorPastWeeklyBO extends CLComponent {
    state = {
        search: {},
        pagination: {
            total: 0,
    ...
    download( target ) {
        ...
        setTimeout(() => {
            TB = tableexport( document.querySelector("#ex-table-operator-past-weekly-bo"), {formats: ['csv','txt','xlsx']});
        }, 100 );
    }
    ...
    renderBody() {
        ...
        return (
            <div className="credit-collection" key="credit-collection">
                ...
                >
                    <table className="ex-table" id="ex-table-operator-past-weekly-bo">
                        <thead>
                            <tr>
                                {th.map( function( doc ) {
...
export default OperatorPastWeeklyBO;
