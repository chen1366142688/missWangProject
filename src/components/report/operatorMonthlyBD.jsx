...
let { contentType, getMonthBusinessReport } = Interface;
let TB;

//运营周报 业务方向 总体业务数据

class OperatorMonthlyBD extends CLComponent {
    state = {
        search: {},
        pagination: {
            total: 0,
    ...
    loadData( search, page, sorter ) {
        ...
        const settings = {
            contentType,
            method: 'post',
            url: getMonthBusinessReport.url,
    ...
    download( target ) {
        ...
        setTimeout(() => {
            TB = tableexport( document.querySelector( "#ex-table-operator-monthly-bd" ), { formats: ['csv','txt','xlsx'] } );
        }, 100 );
    }
    ...
    renderBody() {
        ...
        const columns = [
                         ...
                         },
                         {
                             ...
                             title: '平均借款金额',
                             dataIndex: 'avgLendingAmount',
                             width: 200,
                             render( index, record ) {
                                 return CL.cf( record.avgLendingAmount, 2 )
                             }
                         }, {
                             title: '注册人数',
        ...
        return (
            <div className="credit-collection" key="credit-collection">
                ...
                >
                    <table className="ex-table" id="ex-table-operator-monthly-bd">
                        <thead>
                            <tr>
                                {th.map( function( doc ) {
                                ...
                                data.map( function( record, index ) {
                                    return (
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>{CL.cf( record.avgLendingAmount,0)}</td>
...
export default OperatorMonthlyBD;
